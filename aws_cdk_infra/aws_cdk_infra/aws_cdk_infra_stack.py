...
#             self,
#             "GithubIssuesEKSCluster",
#             version=eks.KubernetesVersion.V1_30,
#             vpc=vpc,
#             default_capacity=2,
#             kubectl_layer=aws_cdk.lambda_layer_kubectl_v33.KubectlV33Layer(self, "KubectlLayer"),
#             cluster_name="github-issues-eks-cluster",
#         )


#         # Optional: Add IAM role for accessing AWS resources from EKS (e.g., S3, Secrets Manager)
...
#         # Add a managed node group (optional — overrides default capacity)
